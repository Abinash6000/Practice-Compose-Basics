    ...
    Column(Modifier.fillMaxWidth()) {
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.m1),
                backgroundColor = Color(0xFFEADDFF),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.t2),
                description = stringResource(R.string.m2),
        ...
        Row(Modifier.weight(1f)) {
            ComposableInfoCard(
                ...
                description = stringResource(R.string.m3),
                backgroundColor = Color(0xFFB69DF8),
                modifier = Modifier.weight(1f)
            )
            ComposableInfoCard(
                title = stringResource(R.string.t4),
                description = stringResource(R.string.m4),
